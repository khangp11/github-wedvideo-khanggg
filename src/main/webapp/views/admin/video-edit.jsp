        ...
        <div class="container-fluid">
         ...
         <div class="col-md-6 p-3">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                	<a class="nav-link nav-link-4" href="videoi?action=view">View</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-4" href="videoi?action=edit">Edit</a>
                </li>
            </ul>
            </div>
        </div>
    ...
    <div class="page-wrapper col-md-12">
			<div class="content container-fluid">
				<div class="page-name 	mb-4">
					...
					<input type="text"class="form-control" value="${video != null ? video.title : ''}" id="title">	
					<label for="inputTitle">Href</label> 
					<input type="text"class="form-control" value="${video != null ? video.href : ''}"  id="href">
					<label for="inputDescription">Description</label>
					<input class="form-control" id="descripition" rows="3" value="${video != null ? video.descripition : ''}"></input>				
					<label for="inputPoster">Poster</label> 
					<input type="text"class="form-control" id="poster" value="${video != null ? video.poster : ''}">
					<input type="hidden"class="form-control" id="isEdit" value="${isEdit}">
					<input type="submit" id="resetBtn" class="btn btn-success" value="Reset" /> <input
						type="submit" id="submitBtn" class="btn btn-success" value="Submit" />
...
<script>
	...
	$('#submitBtn').click(function(){
		var isEdit = $('#isEdit');
		if(isEdit == true ){
			url = '/ASMJAVA/videoi?action=edit&href='+ hrefOrigin;
		}else{
			url = '/ASMJAVA/videoi?action=add'
		}
		var fromData = {
				'title': $('#title').val(),
