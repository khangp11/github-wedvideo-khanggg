<%@ page language="java" contentType="text/html; charset=utf-8"
 ...
 <footer class="tm-bg-gray pt-5 pb-3 tm-text-gray tm-footer">
    ...
    <script>
   		$('#chagePassBtn').click(function(){
   			$('#messageChagePass').text('');
   			var currentPass = $('#currentPass').val();
   			var newPass = $('#newPass').val();
   			var fromData = {'currentPass':currentPass,
   					'newPass':newPass
   					};
   			$.ajax({
   				url:'chagePass',
   				...
   				$('#messageChagePass').text('doi password thanh cong');		
   			}).fail(function(error){  		
   				$('#messageChagePass').text('doi password ko thanh cong');
   			});
   		});
   </script>
